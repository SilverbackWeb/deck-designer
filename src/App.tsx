...
const App: React.FC = () => {
  ...
  const handleSelectStyle = (imageUrl: string) => {
    ...
    setChatHistory([{ role: 'model', text: 'Great choice! How can I refine this design for you?' }]);
  };
  ...
  const handleSendMessage = async (messageText: string) => {
    ...
    const refinementKeywords = ['make', 'change', 'add', 'remove', 'put', 'replace', 'turn', 'edit', 'update', 'style'];
    const isRefinement = refinementKeywords.some(keyword => messageText.toLowerCase().includes(keyword));
